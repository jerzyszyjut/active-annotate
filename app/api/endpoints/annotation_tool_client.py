...
async def get_annotation_tool_clients(
    ...
    return await annotation_tool_client_crud.get_annotation_tool_clients(skip, limit, session)
...
async def get_annotation_tool_client(
    ...
    return await annotation_tool_client_crud.get_annotation_tool_client_by_id(annotation_tool_client_id, session)
...
async def update_annotation_tool_client(
    ...
    return await annotation_tool_client_crud.update_annotation_tool_client(
        annotation_tool_client_id,
        annotation_tool_client_update,
        session
    )
