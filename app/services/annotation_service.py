...
class LSAnnotationService(IAnnotationService):
...
def annotation_service_factory(config: dict) -> IAnnotationService:
    # annotation_service_type = config["type"]

    return LSAnnotationService(
        url=config["url"],
