...
class TestClassificationDatasetAPI:
    ...
    def test_retrieve_dataset(self, api_client, dataset):
    ...
    def test_delete_dataset(self, api_client, dataset):
...
class TestClassificationLabelAPI:
    ...
    def test_retrieve_label(self, api_client, label):
...
class TestClassificationDatapointAPI:
    def test_list_datapoints(self, api_client, datapoint):
        response = api_client.get("/api/data/datapoints/classification/")
        assert response.status_code == status.HTTP_200_OK
        assert len(response.data) == 1

    def test_create_datapoint_with_file(self, api_client, dataset):
        test_file = SimpleUploadedFile(
            "test_image.jpg",
            b"file_content",
            content_type="image/jpeg",
    ...
    def test_create_datapoint_with_label(self, api_client, dataset, label):
        test_file = SimpleUploadedFile(
            "test.jpg",
            b"content",
            content_type="image/jpeg",
    ...
    def test_retrieve_datapoint(self, api_client, datapoint):
    ...
    def test_delete_datapoint(self, api_client, datapoint):
...
class TestClassificationPredictionAPI:
    def test_list_predictions(self, api_client, datapoint, label):
    ...
    def test_create_prediction(self, api_client, datapoint, label):
        data = {
    ...
    def test_create_prediction_invalid_class_index(self, api_client, datapoint):
        data = {
            "datapoint": datapoint.id,
    ...
    def test_retrieve_prediction(self, api_client, datapoint, label):
    ...
    def test_update_prediction(self, api_client, datapoint, label):
        prediction = ClassificationPrediction.objects.create(
            datapoint=datapoint,
            predicted_label=label,
            confidence=0.8,
    ...
    def test_delete_prediction(self, api_client, datapoint, label):
        prediction = ClassificationPrediction.objects.create(
            datapoint=datapoint,
            predicted_label=label,
            confidence=0.9,
